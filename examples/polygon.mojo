...
side by side. The fourth is fill_polygon's AA companion, the pairing
every other filled primitive here (circle/ellipse/arc) has.
...
from canvas.shapes.lines import draw_polygon, draw_polygon_aa
